...
## Project Structure
    ...
    ├── testapiautodatamod_110608  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_110608`
...
2. Clone this repo and `cd testapiautodatamod_110608`
